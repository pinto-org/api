...
const pintoDiamondAbi = require('../../datasources/abi/beanstalk/Pinto-PI14.json');
...
const contracts = {
  ...
  // These use the same as the convert up helpers; can consider a better organization later
  SOW_REFERRAL_TRACTOR_HELPERS: ['0xBCa2F299602c2a43850c8b2FD19D5275D0F388b6', null, convertUpTractorHelpersAbi],
  SOW_REFERRAL_SILO_HELPERS: ['0xE145082A7C5EDd1767f8148A6c29a17488d1eb31', null, convertUpSiloHelpersAbi],
